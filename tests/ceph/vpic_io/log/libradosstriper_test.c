...
int main(int argc, char* argv[])
{
    ...
    ret = cluster.init2("/global/homes/j/jialin/object-store/object_stores/ceph/ceph_conf/client.admin","ceph",0);
    if( ret < 0)
    {
    ...
    ret = cluster.conf_read_file("/global/homes/j/jialin/object-store/object_stores/ceph/ceph_conf/ceph.conf");
    if( ret < 0)
    {
